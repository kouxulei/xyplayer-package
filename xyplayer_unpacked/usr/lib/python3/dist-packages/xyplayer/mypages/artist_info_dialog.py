...
class ArtistInfoDialog(QDialog):
    def __init__(self):
        super(ArtistInfoDialog, self).__init__()
        self.setup_ui()
        self.create_connections()
    
    def setup_ui(self):
        self.setObjectName('playbackPage')
        self.setFixedSize(QSize(400, 545))

        #歌手信息页
        self.artistHeadLabel = QLabel(self)
        self.artistHeadLabel.setGeometry(5, 5, 90, 90)
        self.artistHeadLabel.setScaledContents(True)
        self.artistName = NewLabel(self, True)
        self.artistName.setGeometry(5, 100, 90, 30)
        self.artistGender = QLabel("性别：未知", self)
        self.artistGender.setGeometry(110, 5, 110, 30)
        self.artistBirthday = QLabel("生日：未知", self)
        self.artistBirthday.setGeometry(270, 0, 140, 30)
        self.artistConstellation = QLabel("星座：未知", self)
        self.artistConstellation.setGeometry(110, 50, 110, 30)
        self.artistLanguage = QLabel("语言：未知", self)
        self.artistLanguage.setGeometry(270, 50, 140, 30)
        self.artistBirthplace = QLabel("出生地：未知", self)
        self.artistBirthplace.setGeometry(110, 100, 230, 30)
        self.artistDetail = MyTextEdit(self)
        self.artistDetail.setGeometry(5, 140, 390, 400)
        ...
        self.refreshBtn.setGeometry(355, 90, 40, 40)
